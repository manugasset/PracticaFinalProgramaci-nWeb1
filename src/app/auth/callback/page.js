    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-900">
        <div className="text-center">
          <h1 className="text-2xl font-mono text-red-500 mb-4">Error</h1>
          <p className="text-white font-mono mb-6">{error}</p>
          <button
            onClick={() => router.push('/')}
            className="bg-red-600 text-white px-6 py-2 font-mono rounded hover:bg-red-700"
          >
            Volver al inicio
          </button>
        </div>
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-900">
      <div className="text-center">
        ...
        <p className="text-white font-mono text-xl">Autenticando...</p>
      </div>
    </div>
  );
}